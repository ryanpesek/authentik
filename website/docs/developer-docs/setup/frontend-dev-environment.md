...
5. In a new terminal, navigate to the cloned repository root and start the backend containers with Docker Compose.
    ...
    ```shell
    docker compose -f lifecycle/container/docker-compose.yml up
    ```
